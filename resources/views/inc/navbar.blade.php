<nav class="navbar navbar-expand-md navbar-white bg-white border-bottom sticky-top text-white" id="navbar" style="background: #DA291C !important;">
  <div class="container">
  <a href="{{URL('/')}}" class="navbar-brand">
      <img class="img-fluid" src="{{asset('images/logo/secondary-white-yellow-sun.png')}}" style="height: auto; width: 200px">
  </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        @endauth
        @guest
        <a href="/login" class="btn primary-btn bg-transparent" style="border: 1px solid #fff">Sign up or Log in</a>
        @endguest
      </ul>
    </div>
  </div>
</nav>
<div style="background: #FEC017 !important; width: 100%; height: 30px; margin-top: -1%; padding-top: 0"></div>
