<div class="account-nav">
  <ul class="list-group">
    ...
    <li class="list-group-item list-group-item-action {{ request()->segment(2) == 'view-all-users' ? 'active': ''}}">
      ...
      <li class="list-group-item list-group-item-action {{ request()->segment(2) == 'view-all-employers' ? 'active': ''}}">
          <a href="{{route('account.viewAllEmployers')}}" class="account-nav-link">
              <i class="fas fa-users"></i> Activate Employers
          </a>
      </li>
    @endrole
    @role('author')
