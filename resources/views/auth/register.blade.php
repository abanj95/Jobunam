        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    <h3><img src="{{asset('images/logo/jp.png')}}" width="50px;" alt=""> Create a free job seeker account</h3>
                    <p class="text-muted">Register with basic information, Complete your profile and start applying for vacancies for free!</p>
                </div>
                <div class="login-form">
                    <form action="{{route('register')}}" method="POST">
                        @csrf
                        <input type="hidden" name="user_type" value="{{\App\Definitions\UserTypes::USER}}"/>
                        {{-- fullname --}}
                        ...
                        <div>
                            <small class="text-muted d-block mb-3">By clicking on 'Create Job seeker Account' below you are agreeing to the terms and conditions of UNAM Job Portal.</p>
                        </div>
...
.login-poster {
    /* fallback */
   background-image: url('{{asset("images/nam.jpg")}}');
    background-image: linear-gradient(
            to bottom,
            rgba(0, 0, 0, 0.5),
            rgba(0, 0, 0, 0.35)
        ),
        url('{{asset("images/nam.jpg")}}');
