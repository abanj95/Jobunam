        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    <h3> <img src="{{asset('images/logo/jp.png')}}" width="50px;" alt=""> Job Portal Login</h3>
                    <p class="login-header-title">Welcome back to UNAM Job Portal</p>
                ...
                <div class="login-form">
                    ...
                    <div class="my-3">
                        ...
                        <p>Register as a user?  <a href="/register">User Register</a></p>
                        <p>Register as an employer?  <a href="/employee-register">Employer Register</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<style>
.login-poster {
   background-image: url('{{asset("images/unam_back.jpg")}}');
    background-image: linear-gradient(
            to bottom,
            rgba(0, 0, 0, 0.5),
            rgba(0, 0, 0, 0.35)
        ),
        url('{{asset("images/unam_back.jpg")}}');
