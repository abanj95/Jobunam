            ...
            <div class="col-sm-12 col-md-6 px-0">
                <div class="login-container">
                    <div class="login-header mb-3">
                        <h3><img src="{{asset('images/logo/jp.png')}}" width="50px;" alt=""> Create an employee account</h3>
                        <p class="text-muted">Register with basic information, Complete your profile and start advertising jobs!</p>
                    </div>
                    <div class="login-form">
                        <form action="{{route('register')}}" method="POST">
                            @csrf
                            <input type="hidden" name="user_type" value="{{\App\Definitions\UserTypes::EMPLOYER}}"/>
                            {{-- fullname --}}
                            ...
                            <div>
                                <small class="text-muted d-block mb-3">By clicking on 'Register' below you are agreeing to the terms and conditions of UNAM Job Portal.</p>
                            </div>
