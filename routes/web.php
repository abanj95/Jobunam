...
//public routes
Route::get('/membership-type', [MembershipController::class, 'index'])->name('membership.index');
Route::get('/employee-register', [EmployeeRegisterController::class, 'index'])->name('membership.index');
...
Route::middleware('auth')->prefix('account')->group(function () {
  ...
  Route::group(['middleware' => ['role:admin']], function () {
    ...
    Route::get('view-all-employers', [AdminController::class, 'viewAllEmployers'])->name('account.viewAllEmployers');
    Route::post('view-all-employers', [AdminController::class, 'activateUser'])->name('account.activateUser');
  ...
  Route::group(['middleware' => ['role:author']], function () {
    ...
    Route::get('download/{id}', [JobApplicationController::class, 'download'])->name('jobApplication.download');
